...
OUTPUT_NAME = f"./results/bertweet_predictions.csv"
LOG_FILE = f".results/metrics_log.txt"
SAVE_DIR = "./saved_models/bertweet"
LOGITS_DIR = "./saved_logits/bertweet"
...
# Save to .npz with IDs and texts
...
with open(LOG_FILE, "a") as f:
    ...
    f.write(f"Logits saved to: {LOGITS_DIR}\n")
